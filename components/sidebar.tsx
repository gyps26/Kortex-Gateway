...
export function Sidebar() {
  ...
  const links = [
    ...
    { name: 'Subaccounts', href: '/subaccounts', icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg> },
  ...
  return (
    <aside className="w-64 bg-[#1e2330] flex flex-col flex-shrink-0 min-h-screen text-slate-300">
        <div className="p-5 flex items-center gap-3 border-b border-white/5">
          ...
          <h1 className="text-xl font-extrabold tracking-tight text-white mb-0">Kortex Gateway</h1>
        </div>
